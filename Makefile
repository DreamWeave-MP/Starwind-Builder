...
standalone: plugins-bin
	./build.sh standalone | grep -v "<DATADIR> is\|Output saved in\|Original backed up to\|Can't find \"Data Files\"\|Log"
...
databases: requiredfiles kTools espParser MIG
